...
# # # http 206
# headers = { 'Range': 'bytes=100-' }
# r = requests.get('http://10.0.0.1/myvideo.mp4', headers=headers, verify=False)
# assert(r.status_code == 206 and open(test_dir + '/../myvideo.mp4', 'rb').read()[100:] == r.content)

# headers = { 'Range': 'bytes=36000000-' }
# r = requests.get('https://10.0.0.1/myvideo.mp4', headers=headers, verify=False)
# assert(r.status_code == 206 and open(test_dir + '/../myvideo.mp4', 'rb').read()[36000000:] == r.content)